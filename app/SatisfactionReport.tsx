  ...
  return <>
    <div className="floating-toolbar-frame"><div className={instructorMode ? "survey-toolbar people custom-filters" : "survey-toolbar custom-filters"} aria-label="Filtros de satisfacción">
      {instructorMode ? <>
        ...
        <PopupFilter label="Mes" className="month-filter" value={monthChosen ? month : undefined} options={monthOptions} open={openFilterMenu === "month"} onOpenChange={(open) => setOpenFilterMenu((current) => open ? "month" : current === "month" ? null : current)} onChange={(value) => { setMonth(value); setMonthChosen(true); }} />
